...
<p> This repository has been created to hold all the pages and the associated assets (files/images) for Portfolio Page. Thie page demonstrate the understanding of HTML and CSS based on week 1 classes of Bootcamp and all of its desigs are based on the homework1 guidelines.</p>
